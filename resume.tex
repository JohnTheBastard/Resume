...
\urlstyle{same}{\fontspec[Color=blue1]{SF Hello Light}\href{mailto:xxxxxx@gmail.com}{\color{blue1}xxxxxx@gmail.com} }
| xxx.xxx.xxxx \\
...
\location{2017-2018 | Seattle, WA} (Acquired by Ethos)
%\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
