...
% % % % % % % % % % % % % % % % % % %
\section{Profile}
\descript{\fontspec{Helvetica Light Oblique}Experienced software engineer, mathematician, and former commercial fisherman. A life-long generalist with leveraging broad expertise to direct interdisciplinary teams building software tools for acoustic engineers. I work with smart people to solve hard problems. }
...
\descript{ {\href{https://tomorrow.me}{Tomorrow}} }
