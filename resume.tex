...
\fontspec{SF Hello Light}\urlstyle{same}{\href{mailto:xxxxxx@gmail.com}{\color{blue1}xxxxxx@gmail.com}} | xxx.xxx.xxxx | linkedin: \href{https://www.linkedin.com/in/johndhearn/}{\color{blue1}johndhearn} |
...
% % % % % % % % % % % % % % % % % % %
\section{Profile}
\descript{\fontspec{SF Hello Thin Italic} Experienced software engineer, occasional product manager, generalist, and mathematician. Currently leveraging varied expertise to direct interdisciplinary teams building software tools for acoustic engineers. I like working with smart people to solve hard problems. }
\sectionsep
% % % % % % % % % % % % % % % % % % % 
%  iOS Experience                   % 
% % % % % % % % % % % % % % % % % % %
